	    	...
	    	<div class="container">
	    		<div class="row d-md-flex justify-content-end">
	    			<div class="col-md-12 col-lg-6 half p-3 py-5 pl-lg-5 ftco-animate">
	    				...
	    				<form action="/board/Boardmodify" method="post" class="appointment" enctype="multipart/form-data">
	    					<div class="row">
								<div class="col-md-8">
									<div class="form-group">
		    							<input type="text" id="boardId" name="boardId" class="form-control" value="${boardDetail.boardId }" style="display: none;">
				              			<input type="text" id="boardTitle" name="boardTitle" class="form-control" value="${boardDetail.boardTitle }" placeholder="${boardDetail.boardTitle }">
				            		</div>
								</div>
								<div class="col-md-12">
									<div class="form-group" >
			              			<textarea id="boardContent" name="boardContent" >${boardDetail.boardContent }</textarea>
				            		</div>
								</div>
