  ...
  <body>
	...
	<script>
	    var feed = new Instafeed({
	      ...
	      accessToken: 'IGQVJVMHREVFNTSXBQOE5MTTU0ck5rUTB1bUFSZAjhxeE9qVmF1SFlTTVUxMHZACamZAtaFBycTUtUnR3WTVGSGNNbzU4b2VWc1liZAjB6WWxfY0VtQWxrRTc5cmVMMWFtWUFfdHRUWlR0QVZADNnZAIeFVuYQZDZD'
	    });
	    feed.run();
	</script>
