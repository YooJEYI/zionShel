	    	...
	    	<div class="container">
	    		<div class="row d-md-flex justify-content-end">
	    			<div class="col-md-12 col-lg-6 half p-3 py-5 pl-lg-5 ftco-animate">
	    				<h2 class="mb-4">스타 프로필 작성</h2>
	    				<form action="/board/write" method="post" class="appointment" enctype="multipart/form-data">
	    					<div class="row">
								<div class="col-md-8">
									<div class="form-group">
				              			<input type="text" id="boardTitle" name="boardTitle" class="form-control" placeholder="이름을 입력하세요">
				            		</div>
								</div>
								<div class="col-md-12">
									<div class="form-group" >
			              			<textarea id="boardContent" name="boardContent">소개 내용을 입력하세요</textarea>
				            		</div>
								</div>
